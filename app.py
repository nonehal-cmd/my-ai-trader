...
st.sidebar.markdown("---")
st.sidebar.info("Aapke draw kiye gaye layout ke mutabaq UI update kar diya gaya hai.")
            ...
            if not api_key:
                ...
                with st.spinner("AI aapke layout ke mutabaq data process kar raha hai..."):
                    try:
                        ...
                        # AI ko structured JSON format me response dene ka prompt taaki sahi box me sahi text jaye
                        prompt = """
...
if st.session_state.analyzed:
    ...
    # ─── TOP ROW: SYMBOL | FULL CHART ANALYSIS | SIGNAL | CONF % ───
    ...
    # ─── BOTTOM AREA: IMAGE SIDES & MULTI-GRID BOXES ───
    main_col1, main_col2, main_col3 = st.columns([2.5, 4.5, 4])
    
    # Left Side: Img slots jo aapne design me banaye hain
    with main_col1:
    ...
    # Middle Column: Retail Trader logic & Advanced Technical/Psychology details
    with main_col2:
        st.markdown(f"""
    ...
    # Right Column: Other, News and etc.
    with main_col3:
        st.markdown(f"""
